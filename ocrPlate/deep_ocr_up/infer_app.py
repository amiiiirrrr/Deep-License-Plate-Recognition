...
sys.path.append('ocrPlate/deep_ocr_up/')
import string
import argparse
...
from modules.config_up import BaseConfig
...
class inferOcr:
    def __init__(self):
        ...
        # load model
        print('loading OCR_Up pretrained model from %s' % self.opt.saved_model)
